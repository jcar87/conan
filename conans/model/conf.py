...
BUILT_IN_CONFS = {
    ...
    "tools.cmake.cmaketoolchain:toolset_cuda": "CUDA version (if globally installed) or path to standalone CUDA installation to pass as part of CMAKE_GENERATOR_TOOLSET in CMakeToolchain",
